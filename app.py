...
def init_db():
    ...
    # USSD students table (separate — USSD sessions are stateless per dial)
    cur.execute("""
...
async def ussd_callback(
    ...
    try:
        if state == "LEVEL":
            ...
            return con("Rate Social Studies:\n1. Exceeding\n2. Meeting\n3. Approaching")
            ...
            return con("Rate Technical Skills:\n1. Exceeding\n2. Meeting\n3. Approaching")
